...
INSERT INTO currency (curid,curname) VALUES('RUB','Ruble');
  ...
  INSERT INTO interbank(id, curid, pointDate, date, bid, ask, deleted, trendBid, trendAsk)
	VALUES('1', 'usd', '2016-09-15 17:31:01', '2016-09-15 16:01:01', 26.6600, 26.7000, null, 1, 2);

	INSERT INTO interbank(id, curid, pointDate, date, bid, ask, deleted, trendBid, trendAsk)
	VALUES('2', 'eur', '2016-09-15 17:32:01', '2016-09-15 16:01:01', 29.9740, 30.0160, null, 1, 2);
	...
	INSERT INTO interbank(id, curid, pointDate, date, bid, ask, deleted, trendBid, trendAsk)
	VALUES('7', 'usd', '2016-09-09 17:37:01', '2016-09-08 16:01:01', 12, 23, null, 1, 2);

	INSERT INTO interbank(id, curid, pointDate, date, bid, ask, deleted, trendBid, trendAsk)
	VALUES('8', 'UAH', '2016-09-09 17:38:01', '2016-09-08 16:01:01', 12, 23, null, 1, 2);